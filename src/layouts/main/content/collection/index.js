        ...
        <div className=" md:w-full border-2 border-black-400  mb-20  w-full h-[800px] md:h-[500px] bg-white shadow-2xl rounded-2xl p-4 mt-24">
            ...
            <div className=" p-4">
                <Disclosure>
                    {({ open }) => (
                        <>
                            <Disclosure.Button className="flex justify-between w-full text-left bg-[#f8f3ed] text-[#fab873] border border-[#fab873] font-bold text-base md:text-2xl py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-300 mb-4  md:mb-12">
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            <Disclosure.Button className="flex justify-between w-full text-left bg-[#f8f3ed] text-[#fab873] border border-[#fab873] font-bold text-base md:text-2xl py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-300">
